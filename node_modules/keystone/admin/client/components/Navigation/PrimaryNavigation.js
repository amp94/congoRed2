			...
			<nav className="primary-navbar">
				<Container clearfix>
					<ul className="app-nav app-nav--primary app-nav--left">
						...
						<li data-section-label="Test" data-reactid=".0.0.1.0.1:0.2:$test"><a href="/test" tabindex="-1" data-reactid=".0.0.1.0.1:0.2:$test.0">Test</a></li>
						<li data-section-label="Results" data-reactid=".0.0.1.0.1:0.2:$results"><a href="/keystone/results" tabindex="-1" data-reactid=".0.0.1.0.1:0.2:$test.0">Results</a></li>
						<li data-section-label="Howto" data-reactid=".0.0.1.0.1:0.2:$howto"><a href="/howto" tabindex="-1" data-reactid=".0.0.1.0.1:0.2:$test.0">Howto</a></li>
